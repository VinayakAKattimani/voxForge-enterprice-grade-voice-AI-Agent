    ...
    <div className="container-page">
      ...
      <div className="profile-grid">
        ...
        <Card
          ...
          subtitle="Your activity across VoxForge"
        >
          ...
          <div className="profile-stat-row">
            ...
            <span>
              {dashboardStats.voiceMinutesThisMonth.toLocaleString()} min
            </span>
          </div>
          ...
          <div className="profile-stat-row">
            ...
            <span>
              {Math.round(
                dashboardStats.resolutionRate * 100
              )}%
            </span>
          </div>
